...
| 项目 | 当前状态 |
|---|---|
| 总体状态 | 总体架构已批准，尚未开始功能实现 |
| 当前阶段 | M0：工程基础 |
| 当前工作 | 编写 M0 详细实施计划 |
| 下一里程碑 | 完成 Python 工程骨架、领域模型、SQLite Repository、CLI 和基础 CI |
...
1. 根据总体设计编写 M0 实施计划，并明确文件、测试和提交顺序。
2. 评审 M0 计划。
3. 创建 M0 开发分支或 Worktree。
4. 按测试驱动方式实现工程基础。
5. 验证后提交、推送并更新本文档。
...
| M0 工程基础 | 待开始 | 项目骨架、领域模型、SQLite、CLI、测试和 CI |
