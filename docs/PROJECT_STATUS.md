...
| 当前阶段 | M0：工程规范完善 |
| 当前工作 | 固化并实施中文可读性与英文标识符规范 |
| 下一里程碑 | 完成语言规范调整后启动 M1 知识驱动诊断 |
...
- M0 已合并到本地 `main`；正在完善仓库语言规范。

## 下一步

1. 将语言规范写入 `AGENTS.md`，并中文化现有用户可见文本和代码说明。
2. 运行全量测试、静态检查和 CLI 验收。
3. 推送本地 `main` 并确认 GitHub CI。
4. 创建 M1 详细实施计划。
